...
export class OnboardingComponent implements OnInit {
    ...
    private t: NgbTabset;
    constructor(private _formBuilder: FormBuilder,private ref: ChangeDetectorRef,private modalService: NgbModal) {
    }
...
// to select tab programmatically
     // this.tabSelected="step1"
      ...
      this.mobileapp=this._formBuilder.group({
        ...
        atlernateNumber: ['', Validators.required],
      });
      ...
      this.assignBikerIDNo = this._formBuilder.group({
    ...
    copyMobileNo()
    {
      this.copiedMobileNo=this.bikerMobileNo
    }
    EditMobileNo(content){
      this.editedMobile=this.bikerMobileNo
      this.modalService.open(content)
    }
    updateMobile(){
      this.modalService.dismissAll()
      this.bikerMobileNo=this.editedMobile
      /*---final submit --*/
    }
  }
